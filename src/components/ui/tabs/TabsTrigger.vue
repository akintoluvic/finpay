...
<template>
  <TabsTrigger
    ...
    :class="cn(
      ...
      props.class,
      !!props.myStyle
        ? 'border-b-2 bg-secondary-foreground border-secondary-foreground/20 text-border data-[state=active]:text-secondary data-[state=active]:bg-white data-[state=active]:border-primary text-slate-500 dark:bg-slate-800 dark:text-slate-400'
